...
// expected-note@-2 {{candidate constructor (the implicit copy constructor) not viable: no known conversion from 'S1' to 'const S2' for 1st argument}}
// expected-note@-3 {{candidate constructor (the implicit move constructor) not viable: no known conversion from 'S1' to 'S2' for 1st argument}}
...
#if __cpp_aggregate_paren_init < 201902
  // expected-error@-2 {{no matching conversion for static_cast from 'S1' to 'S2'}}
#else
