...
#else
      // expected-error@#cmp {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void'}}
#endif
...
#else
      // expected-error@#cmparray {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void'}}
#endif
